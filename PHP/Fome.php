...
echo $Save = " INSERT INTO `student_info`( `Frist Name`, `Last Name`, `Father Name`, `Mother Name`, `Phone`, `Email`,`Image`, `Date`, `Gender`, `Hobbies`, `Address`) 
VALUES ('".$Fname."','".$Lname."','".$Father."','".$Mother."','".$Phone."','".$Email."','".$FilePath."','".$DOB."','".$Gen."','".$CheakBoxData."','".$Add."')";
