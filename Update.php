...
$Update="UPDATE `student_info` SET `ID`='$ID',`Fname`='$Fname',`Lname`='$Lname',`Father`='$Father',`Mother`='$Mother',`Phone`='$Phone',`Email`='$Email',`Image`='$FilePath',`Date`='$DOB',`Gender`='$Gen',`Hobbies`='$CheakBoxData',`Address`='$Add' WHERE id='".$ID."'";
